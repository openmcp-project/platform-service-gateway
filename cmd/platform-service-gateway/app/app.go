...
func NewPlatformServiceGatewayCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "platform-service-gateway",
		Short: "platform-service-gateway provides a Kubernetes Gateway API implementation.",
	}
